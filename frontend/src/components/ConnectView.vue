    ...
    <div class="connect-card">
      ...
      <template v-if="step === 'connect'">
        ...
        <details class="how-to">
          <summary>How do I get these? (2 min setup)</summary>
          <ol class="how-steps">
            ...
            <li>Copy <strong>Project URL</strong> and paste above</li>
            <li>Copy <strong>anon / public</strong> key and paste above</li>
            <li>Click Connect — the app will set up your database automatically</li>
          </ol>
        </details>
      </template>
