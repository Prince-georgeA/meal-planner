      ...
      <template v-if="step === 'connect'">
        ...
        <div class="setup-accordion">
          ...
          <details class="setup-panel" open>
            ...
            <ol class="how-steps">
              <li>Go to <a href="https://supabase.com" target="_blank" rel="noopener">supabase.com</a> → sign up free</li>
              <li>Click <strong>New Project</strong> → give it any name → wait ~1 min</li>
              <li>Go to <strong>Project Settings → API</strong></li>
              <li>Copy <strong>Project URL</strong> → paste into the field above</li>
              <li>Copy <strong>anon / public</strong> key → paste into the field above</li>
            </ol>
          </details>
          ...
          <details class="setup-panel">
            <summary class="setup-panel-head">
              ...
              <span class="setup-panel-title">Run the database schema SQL <span class="required-badge">Required</span></span>
              <span class="setup-chevron">›</span>
            </summary>
            <div class="schema-body">
              <p class="schema-desc">
                Before connecting, run this SQL once in your Supabase project to create the
                tables the app needs. It takes about 30 seconds.
              </p>
              <div class="schema-steps">
                <div class="schema-step">
                  <span class="ss-num">1</span>
                  <span>Open your <a :href="supabaseEditorUrl" target="_blank" rel="noopener">Supabase SQL Editor ↗</a></span>
                </div>
                <div class="schema-step">
                ...
                <div class="schema-step">
                  ...
                  <span>Come back here and click <strong>Connect & Continue</strong></span>
                </div>
              </div>
              <div class="sql-box">
          ...
          <details class="setup-panel">
            <summary class="setup-panel-head">
              ...
              <span class="setup-panel-title">Click Connect & Continue above</span>
              <span class="setup-chevron">›</span>
            </summary>
            <p class="how-steps" style="padding: 10px 14px; margin:0;">
              The app will verify your credentials and confirm the tables are ready.
              Your data will be stored exclusively in your own Supabase project —
